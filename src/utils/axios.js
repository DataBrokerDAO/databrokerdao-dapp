...
export default function getAxios(
  ...
  if (noAuthorization)
    ...
    const anonymousJWTToken =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI1YmEyM2JmNDhlODUyODAwMjU3ZGRkMTciLCJpYXQiOjE1MzczNTg5MTR9.ZAzNsbMrqkPqn8tyKROExWjcHZaj1P85zriNrjvGjGU';
    instance = axios.create({
      baseURL: process.env.REACT_APP_DAPI_URL,
